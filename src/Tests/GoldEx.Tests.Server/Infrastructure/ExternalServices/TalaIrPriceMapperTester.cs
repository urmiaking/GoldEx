...
public class TalaIrPriceMapperTester
{
    ...
    public void MapCoinPrices_ValidInput_ReturnsCorrectPrices()
    {
        ...
        var responses = new TalaIrApiResponse
        {
            ...
            {
                { "sekke-gad", new CoinInfo { Title = "قديم", Value = "70,500,000", LastUpdate = "1403/05/06", Change = "100,000 (0.14%)" } },
                { "sekke-jad", new CoinInfo { Title = "جديد", Value = "74,300,000", LastUpdate = "1403/05/06", Change = "100,000 (0.13%)" } }
            }
        };
        ...
        Assert.That(oldCoin.CurrentValue, Is.EqualTo(705000000)); // Check the parsed value
        ...
        Assert.That(newCoin.CurrentValue, Is.EqualTo(743000000)); // Check the parsed value
    ...
    public void MapGoldPrices_ValidInput_ReturnsCorrectPrices()
    {
        ...
        var responses = new TalaIrApiResponse
        {
            ...
            {
                { "gold_ounce", new GoldInfo { Title = "اونس طلا", Value = "2,882.23", LastUpdate = "1403/05/06", Change = "-0.32 (0.01%)" } },
                { "gold_24k", new GoldInfo { Title = "طلای 24 عیار", Value = "8,724,000", LastUpdate = "1403/05/06", Change = "-9,233 (0.11%)" } } // Example of another Gold item
            }
        };
        ...
        Assert.That(goldOunce.CurrentValue, Is.EqualTo(28822.3m));
        ...
        Assert.That(gold24K.CurrentValue, Is.EqualTo(87240000));
    ...
    public void MapCurrencyPrices_ValidInput_ReturnsCorrectPrices()
    {
        ...
        var responses = new TalaIrApiResponse
        {
            CurrencyPrice = new Dictionary<string, CurrencyInfo>
                {
                    { "arz_dolar", new CurrencyInfo { Title = "دلار", Value = "1739645575", LastUpdate = "1403/05/06", Change = "-30,440 (100%)", UnitTimeStamp = 1739728180 } },
                    { "arz_euro", new CurrencyInfo { Title = "یورو", Value = "0", LastUpdate = "1403/05/06", Change = "-32,500 (100%)" } } // Example of another currency
                }
        };
        ...
        {
            Assert.That(dollarValue, Is.EqualTo(17396455750d));
        }
        else
        {
