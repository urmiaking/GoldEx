...
{
    Task<List<GetCustomerRemainingResponse>> GetCustomerRemainingListAsync(Guid customerId, Guid? priceUnitId, DateTime? untilDate = null, Guid? invoiceId = null, CancellationToken cancellationToken = default);
