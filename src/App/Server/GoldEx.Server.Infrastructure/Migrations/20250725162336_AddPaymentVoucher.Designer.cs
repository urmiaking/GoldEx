...
namespace GoldEx.Server.Infrastructure.Migrations
{
    ...
    [Migration("20250725162336_AddPaymentVoucher")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.BankAccountAggregate.BankAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.BankAccountAggregate.BankAccount", b =>
                {
                    ...
                    b.OwnsOne("GoldEx.Server.Domain.BankAccountAggregate.InternationalBankAccount", "InternationalAccount", b1 =>
                        {
                    ...
                    b.OwnsOne("GoldEx.Server.Domain.BankAccountAggregate.LocalBankAccount", "LocalAccount", b1 =>
                        {
                            b1.Property<Guid>("BankAccountId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.PaymentVoucherAggregate.PaymentVoucher", b =>
                {
                    ...
                    b.HasOne("GoldEx.Server.Domain.BankAccountAggregate.BankAccount", "BankAccount")
                        .WithMany()
                        .HasForeignKey("BankAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
