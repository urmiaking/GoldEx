...
namespace GoldEx.Server.Infrastructure.Migrations
{
    ...
    [Migration("20250821103623_AddTradeIns")]
    partial class AddTradeIns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.InvoiceAggregate.Invoice", b =>
                {
                    ...
                    b.OwnsMany("GoldEx.Server.Domain.InvoiceAggregate.InvoiceTradeIn", "TradeIns", b1 =>
                        {
                            b1.Property<Guid>("InvoiceId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.Property<Guid?>("ResultingProductId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasIndex("ResultingProductId");

                            b1.ToTable("InvoiceTradeIns", (string)null);

                            b1.WithOwner("Invoice")
                                .HasForeignKey("InvoiceId");

                            b1.HasOne("GoldEx.Server.Domain.ProductAggregate.Product", "ResultingProduct")
                                .WithMany()
                            ...
                            b1.Navigation("ResultingProduct");
                        });
