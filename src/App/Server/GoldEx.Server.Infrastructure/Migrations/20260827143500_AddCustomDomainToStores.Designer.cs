...
namespace GoldEx.Server.Infrastructure.Migrations
{
    ...
    [Migration("20260827143500_AddCustomDomainToStores")]
    partial class AddCustomDomainToStores
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.CustomerTransferVoucherAggregate.CustomerTransferVoucher", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("DestinationInvoiceId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DestinationInvoiceId");
                    ...
                    b.ToTable("CustomerTransferVouchers", (string)null);
                });
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.InvoicePaymentAggregate.InvoicePayment", b =>
                {
                    ...
                    b.Property<Guid?>("CustomerTransferVoucherId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.OAuthAggregate.OAuthAuthorizationCode", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.OAuthAggregate.OAuthClient", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.OAuthAggregate.OAuthToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.PersonalAccessTokenAggregate.PersonalAccessToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.CustomerTransferVoucherAggregate.CustomerTransferVoucher", b =>
                {
                    b.HasOne("GoldEx.Server.Domain.CustomerAggregate.Customer", "DestinationCustomer")
                        .WithMany()
                        .HasForeignKey("DestinationCustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GoldEx.Server.Domain.InvoiceAggregate.Invoice", "DestinationInvoice")
                        .WithMany()
                        .HasForeignKey("DestinationInvoiceId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("GoldEx.Server.Domain.CustomerAggregate.Customer", "SourceCustomer")
                        .WithMany()
                        .HasForeignKey("SourceCustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GoldEx.Server.Domain.InvoiceAggregate.Invoice", "SourceInvoice")
                        .WithMany()
                        .HasForeignKey("SourceInvoiceId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("DestinationCustomer");

                    b.Navigation("DestinationInvoice");
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.InvoicePaymentAggregate.InvoicePayment", b =>
                {
                    ...
                    b.Navigation("CustomerTransferVoucher");
