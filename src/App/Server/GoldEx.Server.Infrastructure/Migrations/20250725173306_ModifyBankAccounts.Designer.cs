...
namespace GoldEx.Server.Infrastructure.Migrations
{
    ...
    [Migration("20250725173306_ModifyBankAccounts")]
    partial class ModifyBankAccounts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.PaymentVoucherAggregate.PaymentVoucher", b =>
                {
                    ...
                    b.Property<Guid>("AmountPriceUnitId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.PaymentVoucherAggregate.PaymentVoucher", b =>
                {
                    b.HasOne("GoldEx.Server.Domain.PriceUnitAggregate.PriceUnit", "AmountPriceUnit")
                        .WithMany()
                        .HasForeignKey("AmountPriceUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("GoldEx.Server.Domain.FinancialAccountAggregate.FinancialAccount", "BankAccount")
                        .WithMany()
                        .HasForeignKey("FinancialAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
