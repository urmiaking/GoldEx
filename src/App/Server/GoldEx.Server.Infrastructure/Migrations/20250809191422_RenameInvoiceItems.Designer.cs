...
namespace GoldEx.Server.Infrastructure.Migrations
{
    ...
    [Migration("20250809191422_RenameInvoiceItems")]
    partial class RenameInvoiceItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.InvoiceItemProductAggregate.InvoiceProductItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InvoiceProductItems", (string)null);
                });
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.InvoiceItemProductAggregate.InvoiceProductItem", b =>
                {
                    ...
                    b.HasOne("GoldEx.Server.Domain.ProductAggregate.Product", "PurchaseProduct")
                        .WithOne("PurchaseInvoiceProductItem")
                        .HasForeignKey("GoldEx.Server.Domain.InvoiceItemProductAggregate.InvoiceProductItem", "PurchaseProductId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("GoldEx.Server.Domain.ProductAggregate.Product", "SellProduct")
                        .WithOne("SellInvoiceProductItem")
                        .HasForeignKey("GoldEx.Server.Domain.InvoiceItemProductAggregate.InvoiceProductItem", "SellProductId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.ProductAggregate.Product", b =>
                {
                    b.Navigation("PurchaseInvoiceProductItem");

                    b.Navigation("SellInvoiceProductItem");
                });
