...
namespace GoldEx.Server.Infrastructure.Migrations
{
    ...
    [Migration("20250801145358_ModifyVoucherRelationShip")]
    partial class ModifyVoucherRelationShip
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GoldEx.Server.Domain.InvoiceItemAggregate.InvoiceItem", b =>
                {
                    ...
                    b.HasOne("GoldEx.Server.Domain.ProductAggregate.Product", "Product")
                        .WithOne("InvoiceItem")
                        .HasForeignKey("GoldEx.Server.Domain.InvoiceItemAggregate.InvoiceItem", "ProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
