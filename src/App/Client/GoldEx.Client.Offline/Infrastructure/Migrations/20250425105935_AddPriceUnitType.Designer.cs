...
namespace GoldEx.Client.Offline.Infrastructure.Migrations
{
    ...
    [Migration("20250425105935_AddPriceUnitType")]
    partial class AddPriceUnitType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoldEx.Client.Offline.Domain.CustomerAggregate.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("GoldEx.Client.Offline.Domain.TransactionAggregate.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("GoldEx.Client.Offline.Domain.TransactionAggregate.Transaction", b =>
                {
                    b.HasOne("GoldEx.Client.Offline.Domain.CustomerAggregate.Customer", "Customer")
                        .WithMany()
