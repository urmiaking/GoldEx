...
public partial class SellInvoiceReportView
{
    [Parameter] public List<SellInvoiceRpResponse>? Items { get; set; }
    [Parameter] public EventCallback OnPrintReport { get; set; }
    [Parameter] public bool IsLoading { get; set; }

    private SellInvoiceFilterVm.SellInvoiceReportSummary? _summary;
    ...
    private string GetAmount(SellInvoiceRpResponse context)
    {
    ...
    private Color GetAmountColor(SellInvoiceRpResponse context)
    {
        var remainingAmount = context.RemainingPrice;
