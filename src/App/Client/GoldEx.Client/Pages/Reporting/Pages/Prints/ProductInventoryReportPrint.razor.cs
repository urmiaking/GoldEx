...
{
    [Parameter, SupplyParameterFromQuery] public Guid? ProductCategoryId { get; set; }

    [Parameter, SupplyParameterFromQuery] public string? ItemType { get; set; }

    [Parameter, SupplyParameterFromQuery] public string? ItemStatus { get; set; }
